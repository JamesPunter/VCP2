...
const socialIcon =
  'flex size-10 shrink-0 items-center justify-center rounded-full bg-neutral-800 text-white shadow-sm ring-1 ring-white/5'
  ...
  return (
    <footer className="border-t border-white/[0.06] bg-neutral-950 text-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10 sm:flex-row sm:items-center sm:justify-between sm:gap-12 sm:py-12">
        ...
        <div className="flex shrink-0 items-center gap-3 sm:pl-4" aria-hidden={true}>
